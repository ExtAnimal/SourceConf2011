...
Ext.onReady(function() {
    ...
    var availablePhones = Ext.create('Ext.view.View', {
        store: getPhoneStore(),
    ...
    var dragZone = Ext.create('Ext.view.DragZone', {
        ddGroup: 'phones',
        view: availablePhones
    });

    var shoppingCart = Ext.create('Ext.view.View', {
        id: 'cart',
        store: {
            proxy: {
                type: 'memory',
    ...
    var dropZone = Ext.create('Ext.view.DropZone', {
        ddGroup: 'phones',
        view: shoppingCart,
